...
execute if entity @s[tag=!afk_sit.is_sitting,tag=!afk_sit.ignore,predicate=afk_sit:on_ground] at @s unless block ~ ~-0.1 ~ afk_sit:air anchored eyes positioned ^ ^ ^ if entity @s[distance=1..] run function afk_sit:sit
