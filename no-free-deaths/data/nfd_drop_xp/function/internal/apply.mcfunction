execute as @s store result score @s nfd_drop_xp.lost_levels run xp query @s levels
execute store result score @s nfd_drop_xp.lost_points run xp query @s points
...
execute if score @s nfd_drop_xp.lost_levels matches 2.. run scoreboard players operation @s nfd_drop_xp.lost_levels *= .drop_percentage nfd_drop_xp.settings
execute if score @s nfd_drop_xp.lost_levels matches 2.. run scoreboard players operation @s nfd_drop_xp.lost_levels /= .100 nfd_drop_xp.const

scoreboard players operation @s nfd_drop_xp.levels_to_remove = @s nfd_drop_xp.lost_levels
execute if score @s nfd_drop_xp.levels_to_remove matches 1.. as @s run function nfd_drop_xp:internal/remove_xp
...
execute if score .drop_full_xp nfd_drop_xp.settings matches 1.. run return run function nfd_drop_xp:internal/full_drop/drop
function nfd_drop_xp:internal/vanilla_drop/drop
