...
# *actually* random.
execute if score @s no_free_deaths.drop_xp.xp_orb_values matches 2477.. run function nfd_drop_xp:internal/summon_orb/2477/a
...
execute if score @s no_free_deaths.drop_xp.xp_orb_values matches 73.. run function nfd_drop_xp:internal/summon_orb/73/a
execute if score @s no_free_deaths.drop_xp.xp_orb_values matches 37.. run function nfd_drop_xp:internal/summon_orb/37/a
execute if score @s no_free_deaths.drop_xp.xp_orb_values matches 17.. run function nfd_drop_xp:internal/summon_orb/17/a
execute if score @s no_free_deaths.drop_xp.xp_orb_values matches 7.. run function nfd_drop_xp:internal/summon_orb/7/a
