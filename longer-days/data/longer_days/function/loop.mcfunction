...
# we're in sync with what we expected. At the end of the function, we know that we're
...
#     we could pause for the same time of day (dependining on exactly when
...
# so it's not checked with the gamerule.
